...
namespace primitive {
	...
	public:
		...
		} // getIconStatic(fa_laptop); }

        static QIcon getAboutIcon()
        {
            return getInstance().getIcon(fa_info_circle, QColor(0, 122, 204));
        }

        static QIcon getFlyIcon()
        {
        ...
        static QIcon getTurntableIcon()
        {
            return getIconStatic(fa_bullseye);
        }
		...
		{
            return getInstance().getIcon(fa_users, QColor(0, 122, 204));
		}
		...
		{
            return getIconStatic(fa_map_marker);
		}
        ...
        static  QIcon getSceneGraphOptimizeIcon()
        {
            return getIconStatic(fa_magic);
        }
        ...
        static QIcon get3DDiffIcon()
        {
            return getIconStatic(fa_wrench);
        }

        static QIcon getClippingPlaneIcon()
        {
            return getIconStatic(fa_sliders);
        }

        static QIcon getRepositoriesIcon()
        {
            return getIconStatic(fa_database);
        }

        static QIcon getLogIcon()
        {
            return getIconStatic(fa_code);
        }
